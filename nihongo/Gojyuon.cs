...
namespace nihongo
{
    ...
    {
        public static readonly string hiragana = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをん";//平假名
        public static readonly string katagana = "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲン";//片假名
        public static readonly string[] duyin1 = new string[] { "a", "i", "u", "e", "o", "ka", "ki", "ku", "ke", "ko", "sa", "shi", "su", "se", "so", "ta", "chi", "tsu", "te", "to", "na", "ni", "nu", "ne", "no", "ha", "hi", "fu", "he", "ho", "ma", "mi", "mu", "me", "mo", "ya", "yu", "yo", "ra", "ri", "ru", "re", "ro", "wa", "wo","n" };

        public static readonly string zhuoyin1 = "がぎぐげござじずぜぞだぢづでどばびぶべぼぱぴぷペぽ";
        public static readonly string zhuoyin2 = "ガギグゲゴザジズゼゾダヂヅデドバビブべボパプぷペポ";
